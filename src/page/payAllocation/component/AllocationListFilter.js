...
@observer
class AllocationListFilter extends React.Component{
    render(){
        return (
            <div className={`filter ${this.props.filterClassName}`}>
                <div className="filter-box">
                    ...
                    />
                    <FilterChoose label='类型' name="Type" hideItem={this.props.hideItem}
                                  handleClick={this.props.handleClickChose}
                                  value={this.props.param.TypeName}
...
export default AllocationListFilter;
