...
@observer
class PreAllocationDetail extends React.Component {
    @observable data = {
        ...
        axios({
            ...
            if (res.data.code === '00') {
                ...
                setTimeout(() => {
                    ...
                    sessionStorage.setItem("addType", '分配');
                    window.location.href = '/home/allocationSubmitSuccess';
                }, 1000);
            } else {
                this.data.isShowTips = true;
                this.data.tipsText = res.data.msg;
        ...
        return (
            <div className="wrapper">
                <div className="wrapper-detail colorAddBG">
                    ...
                    <AlterTips isShowToast={this.data.isShowToast} text="是否提交本次分配单据？"
                    ...
                    <AddBudgetProgressBar oneTit='分配明细' twoTit='预览' threeTit='提交'
                    ...
                    <div className="content_mainS">
                        <div className="content_mainDetail">
                            <div className='detailBorder borderBottom'>
                                ...
                                <DetailBold label="分配原因" value={detail.Note} />
                            </div>
                            <div className='detailBorder detailMarTop'>
                                <DetailNormal label="部门" value={detail.DeptName} />
                                <DetailNormal label="项目" value={detail.ItemName} />
                                <DetailNormal label="金额" value={`${detail.Money || '0.00'}元`} />
                                <DetailNormal label="备注" value={detail.Context} />
                            </div>
                        </div>
                    </div>
                </div>
...
export default PreAllocationDetail;